...
class Evaluation(models.Model):
    ...
    location_latitude = models.DecimalField(max_digits=10, decimal_places=7, null=True, blank=True, verbose_name='خط العرض')
    location_longitude = models.DecimalField(max_digits=10, decimal_places=7, null=True, blank=True, verbose_name='خط الطول')
    location_url = models.URLField(max_length=500, blank=True, verbose_name='رابط الموقع المباشر')
